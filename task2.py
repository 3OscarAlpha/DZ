...
for i in range(0, len(column_obj_norm)):
    print(f"В данной базе данных представлены: объект {catalog[0][i]} в фильтрах {catalog[1][i]}")
# print(f"В данной базе данных представлены: объект {catalog[0][0]} в фильтрах {catalog[1][0]}")
#
...
print("the date is", a) #2455896.30476
